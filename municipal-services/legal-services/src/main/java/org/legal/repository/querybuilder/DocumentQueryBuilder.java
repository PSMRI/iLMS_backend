...
public class DocumentQueryBuilder {
    private static final String Query = "select count(*) OVER() AS document_full_count, id, case_id, document_type, file_store_id, status, remarks, createdby, createdtime, lastmodifiedby, lastmodifiedtime from eg_lg_document ";
