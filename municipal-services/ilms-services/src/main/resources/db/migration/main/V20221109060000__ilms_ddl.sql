CREATE TABLE IF NOT EXISTS  ilms_case(
    ...
    application_no character varying(32) DEFAULT NULL,
    is_case_number_correct boolean DEFAULT NULL,
	...
	department_name character varying(32) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  ilms_hearing(
   ...
   court_id character varying(32) DEFAULT NULL,
