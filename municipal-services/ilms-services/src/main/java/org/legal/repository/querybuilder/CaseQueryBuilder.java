...
public class CaseQueryBuilder {
    ...
    private static final String Query = "select count(*) OVER() AS full_count,eg_lg_case.id as ilmsCase_id, eg_lg_case.case_number as eg_lg_caseNumber, eg_lg_case.cnr_number as ilms_cnrNumber, eg_lg_case.tenant_id as ilms_tenantId, eg_lg_case.parent_case_id as ilms_parentCaseId, eg_lg_case.linked_cases as ilms_linkedCases, eg_lg_case.case_type as ilms_caseType, eg_lg_case.case_category as ilms_caseCategory, eg_lg_case.filing_number as ilms_filingNumber, eg_lg_case.filing_date as ilms_filingDate, eg_lg_case.registrtion_date as ilms_registrationDate, eg_lg_case.case_summary as ilms_caseSummary, eg_lg_case.arising_details as ilms_arisingDetails, eg_lg_case.policy_or_nonpolicy_matter as ilms_matter, eg_lg_case.case_status as ilms_caseStatus, eg_lg_case.case_stage as ilms_caseStage, eg_lg_case.case_sub_stage as ilms_caseSubStage, eg_lg_case.priority as ilms_priority, eg_lg_case.recommend_oic as ilms_recommendOic, eg_lg_case.remarks as ilms_remarks, eg_lg_case.additional_details as ilms_additionalDetails, eg_lg_case.status as ilms_status, eg_lg_case.createdby as ilms_createdBy, eg_lg_case.createdtime as ilms_createdTime, eg_lg_case.lastmodifiedby as ilms_lastModifiedBy, eg_lg_case.lastmodifiedtime as ilms_lastModifiedTime, eg_lg_act.id as actId, eg_lg_act.case_id as actCaseId, eg_lg_act.name as actName,eg_lg_court.id as court_id, eg_lg_court.case_id as court_caseId, eg_lg_court.court_name as court_name, eg_lg_court.district as court_district, eg_lg_court.state as court_state, eg_lg_court.division as court_division,eg_lg_court.status as court_status, eg_lg_court.createdby as court_createdby,eg_lg_court.createdtime as court_createdtime,eg_lg_court.lastmodifiedby as court_lastmodifiedby,eg_lg_court.lastmodifiedtime as court_lastmodifiedtime, eg_lg_act.section_number as actSectionNumber, eg_lg_act.status as actStatus,  eg_lg_act.createdby as act_createdBy, eg_lg_act.createdtime as act_createdTime, eg_lg_act.lastmodifiedby as act_lastModifiedBy, eg_lg_act.lastmodifiedtime as act_lastModifiedTime FROM eg_lg_case LEFT OUTER JOIN eg_lg_court on eg_lg_court.case_id = eg_lg_case.id  LEFT OUTER JOIN eg_lg_act on eg_lg_act.case_id = eg_lg_case.id";
