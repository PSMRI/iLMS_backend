...
public class CaseController {
    ...
    public ResponseEntity<CaseSearchResponse> search(@Valid @RequestBody RequestInfoWrapper requestInfoWrapper,
                                                     @Valid @ModelAttribute CaseSearchCriteria criteria) {
        log.info("ILMSCaseController :: search() : START ");
        CaseSearchResponse response = caseService.ilmsCaseSearch(criteria, requestInfoWrapper.getRequestInfo(), requestInfoWrapper.getProcessSearchCriteria());
    ...
    public ResponseEntity<CaseResponse> create(@Valid @RequestBody CaseRequest caseRequest) {
        ...
        CaseResponse response = CaseResponse.builder().caseObj(caseObj)
