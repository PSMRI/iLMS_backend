...
public class CaseQueryBuilder {
    ...
    private static final String Query = "select count(*) OVER() AS full_count,ilms_case.id as ilmsCase_id, ilms_case.case_number as ilms_caseNumber, ilms_case.cnr_number as ilms_cnrNumber, ilms_case.tenant_id as ilms_tenandId, ilms_case.parent_case_id as ilms_parentCaseId, ilms_case.state as ilms_state, ilms_case.district as ilms_district, ilms_case.division as ilms_division, ilms_case.court_name as ilms_courtName," + " ilms_case.case_type as ilms_caseType, ilms_case.case_category as ilms_caseCategory," + "  ilms_case.filing_number as ilms_filingNumber, ilms_case.filing_date as ilms_filingDate, ilms_case.registrtion_date as ilms_registrationDate, ilms_case.case_summary as ilms_caseSummary, ilms_case.arising_details as ilms_arisingDetails," + "  ilms_case.policy_or_nonpolicy_matter as ilms_matter, ilms_case.case_status as ilms_caseStatus," + " ilms_case.case_stage as ilms_caseStage, ilms_case.case_sub_stage as ilms_caseSubStage, ilms_case.priority as ilms_priority," + "  ilms_case.department_name as ilms_departmentName, ilms_case.recommend_oic as ilms_recommendOic, ilms_case.remarks as ilms_remarks, ilms_case.additional_details as ilms_additionalDetails, ilms_case.status as ilms_status, " + "  ilms_case.createdby as ilms_createdBy, ilms_case.createdtime as ilms_createdTime, ilms_case.lastmodifiedby as ilms_lastModifiedBy, ilms_case.lastmodifiedtime as ilms_lastModifiedTime, " + "  ilms_act.id as actId, ilms_act.case_id as actCaseId, ilms_act.name as actName, ilms_act.section_number as actSectionNumber, ilms_act.status as actStatus, " + "  ilms_act.createdby as act_createdBy, ilms_act.createdtime as act_createdTime, ilms_act.lastmodifiedby as act_lastModifiedBy, ilms_act.lastmodifiedtime as act_lastModifiedTime" + "	 FROM ilms_case" + "	 LEFT OUTER JOIN ilms_act on ilms_act.case_id = ilms_case.id ";
